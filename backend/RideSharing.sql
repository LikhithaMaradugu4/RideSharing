...
CREATE TABLE lu_fuel_type (
    fuel_code VARCHAR(20) PRIMARY KEY,
    description VARCHAR(100) NOT NULL
);
INSERT INTO lu_fuel_type (fuel_code, description) VALUES
('PETROL', 'Petrol'),
('DIESEL', 'Diesel'),
('CNG', 'Compressed Natural Gas'),
('EV', 'Electric Vehicle');('FLAT'),('PERCENTAGE');
...
('CNG', 'Compressed Natural Gas'),
('EV', 'Electric Vehicle');
CREATE TABLE lu_fleet_type (
    fleet_type_code TEXT PRIMARY KEY,
    description TEXT NOT NULL
);
INSERT INTO lu_fleet_type (fleet_type_code, description) VALUES
...
ALTER TABLE fleet
ADD COLUMN fleet_type TEXT NOT NULL
REFERENCES lu_fleet_type(fleet_type_code)
DEFAULT 'BUSINESS';
...
CREATE TABLE fleet_document (
    ...
    fleet_id BIGINT NOT NULL
        REFERENCES fleet(fleet_id) ON DELETE CASCADE,

    document_type VARCHAR(50) NOT NULL,
    file_url TEXT NOT NULL,

    verification_status TEXT NOT NULL
        REFERENCES lu_approval_status(status_code),
...
CREATE TABLE vehicle_spec (
    ...
    fuel_type VARCHAR(20) NOT NULL
        REFERENCES lu_fuel_type(fuel_code),
...
-- Add file_url column to user_kyc table
ALTER TABLE user_kyc
ADD COLUMN file_url TEXT;

-- Add alternate_phone_number column to driver_profile table
ALTER TABLE driver_profile
ADD COLUMN alternate_phone_number VARCHAR(15);
...
VALUES
(1, '$2b$12$2IKvhs5bTeNn3WSnqOMlPO3jmkGegYpOO6PNiyt0w/Wvr6RdDxCaC', FALSE, now());

INSERT INTO app_user
(full_name, email, role, status, country_code)
VALUES
('Dummy_Rider1','rider1@test.com','RIDER','ACTIVE','IN');
INSERT INTO user_auth
(user_id, password_hash, is_locked, last_password_change)
VALUES
(2, '$2b$12$WGa249S47eGao0tAtGcbeOKakTaXHA1ulmkv3BEd7Q.o8AOrgxluC', FALSE, now());

select * from app_user;
$2b$12$WGa249S47eGao0tAtGcbeOKakTaXHA1ulmkv3BEd7Q.o8AOrgxluC'
select * from user_session;
INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Platform Admin', 'admin@test.com', 'PLATFORM_ADMIN', 'ACTIVE', 'IN', 1);
...
(full_name, email, role, status, country_code, city_id)
VALUES
('TenantAdmin', 'tenantadmin@test.com', 'TENANT_ADMIN', 'ACTIVE', 'IN', 1);
INSERT INTO tenant_admin (tenant_id, user_id, is_primary)
VALUES 
(1, 3, TRUE);
INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Test Driver', 'driver@test.com', 'DRIVER', 'INACTIVE', 'IN', 1);
INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Test Driver1', 'driverone@test.com', 'DRIVER', 'INACTIVE', 'IN', 1);


INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Test Driver2', 'drivertwo@test.com', 'DRIVER', 'INACTIVE', 'IN', 1);


INSERT INTO app_user
(full_name,phone, email, role,status, country_code, city_id)
VALUES
('Test Driver4', '9000000001','driver4@test.com', 'DRIVER', 'INACTIVE', 'IN', 1);

INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Rider A', 'ridera@test.com', 'RIDER', 'ACTIVE', 'IN', 1);

INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Rider B', 'riderb@test.com', 'RIDER', 'INACTIVE', 'IN', 1);

INSERT INTO app_user
(full_name, email, role, status, country_code, city_id)
VALUES
('Rider C', 'riderc@test.com', 'RIDER', 'ACTIVE', 'IN', 1);


$2b$12$8ffBaRjjS2TDy2fI.Ai57.5MTYe.baeXRw8qF1PjRM2Ju4e8ykF5a

INSERT INTO user_auth
(user_id, password_hash, is_locked, last_password_change)
VALUES
(3, '$2b$12$8ffBaRjjS2TDy2fI.Ai57.5MTYe.baeXRw8qF1PjRM2Ju4e8ykF5a', FALSE, now());
...
(user_id, password_hash, is_locked, last_password_change)
VALUES
(4, '$2b$12$8ffBaRjjS2TDy2fI.Ai57.5MTYe.baeXRw8qF1PjRM2Ju4e8ykF5a', FALSE, now());
